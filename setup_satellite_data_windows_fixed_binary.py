...
S5_PATTERN = re.compile(r"^S5P_(NO2|SO2|CO)_(?:Daily_)?(\d{4}-\d{2}-\d{2})\.(tif|nc)$", re.IGNORECASE)
...
def create_sample_config() -> Path:
    config = {
        "paths": {
            "sensor_data": "sensor_data_cleaned_with_binary_labels.csv",
...
╚═══════════════════════════════════════════════════════════════════╝
    ...
    if data_ok:
        ...
        print("  2. Use sensor_data_cleaned_with_binary_labels.csv")
        print("  3. Check config.json for binary classification settings")
        print("  4. Run: python sustainmine_pipeline_v2_fixed_binary.py")
        print("  5. Train: python train_sustainmine_v2_fixed_binary.py")
        print("=" * 70)
    else:
        print("\n" + "=" * 70)
